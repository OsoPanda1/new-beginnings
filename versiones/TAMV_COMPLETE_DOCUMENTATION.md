...
flowchart TD
    ...
    B -->|Safe| C[Aprobado]
    B -->|Suspicious| D[Revisión Humana L1]
    D -->|Safe| C
    D -->|Requiere Escalamiento| E[Moderador Senior L2]
    E -->|Decisión Simple| F[Acción Tomada]
    E -->|Caso Complejo| G[Comité de Ética]
    G --> F
    F --> H[Notificación al Usuario]
    H --> I{Apelación?}
    I -->|Sí| J[Proceso de Apelación]
    I -->|No| K[Caso Cerrado]
```
...
flowchart TD
    ...
    B -->|Crítica| F[Activar Plan de Crisis]
